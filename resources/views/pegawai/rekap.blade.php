<x-header>
  <div class="max-w-3xl mx-auto mt-6 px-4 sm:px-6 space-y-6">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <form action="{{ route('rekap') }}" method="GET" class="flex gap-2">
      ...
      <div class="overflow-x-auto rounded-xl shadow-md">
          <table class="min-w-full divide-y divide-gray-200 text-sm">
              ...
              <tbody class="bg-white divide-y divide-gray-100">
                  ...
                  @empty
                      <tr>
                          <td colspan="4" class="px-6 py-4 text-center text-gray-500">Tidak ada data presensi untuk bulan yang dipilih.</td>
                      </tr>
                  @endforelse
              </tbody>
          </table>
